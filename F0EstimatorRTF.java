...
import javax.swing.text.rtf.RTFEditorKit; // Importierung der RTFEditorKit-Klasse 
//zum Einlesen von RTF-Dateien
...
public class F0EstimatorRTF {
    ...
    public static void main(String[] args) throws Exception {
        ...
        double Delta = 0.005;   // Wahrscheinlichkeit, dass die 
        //Schätzung außerhalb des Toleranzbereichs liegt
        ...
        String Volltext = doc.getText(0, doc.getLength()); // gesamten Text des Dokuments 
        //als String extrahieren
        String[] Zeilenarray = Volltext.split("\\r?\\n"); // Aufteilen des Textes in 
        //Zeilen anhand von Zeilenumbrüchen
